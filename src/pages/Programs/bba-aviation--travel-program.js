        ...
        <div className="our-promise-content">
          <div className="our-promise-text">
            ...
            <h2 className="main-heading">
              ...
              , mastering aviation and travel management to shape the future of
              the industry.
            </h2>
          ...
          <div className="job-stats">
            <div className="stat-box">
              <strong>100+</strong>
              <p>Top-tier aviation and travel companies</p>
            </div>
            <div className="stat-box">
              <strong>1500+</strong>
              <p>Global career opportunities in aviation & travel</p>
            </div>
            <div className="stat-box">
              <strong>35%</strong>
              <p>Transforming the aviation and travel landscape</p>
            </div>
            <Link
              to="../../assets/img/BBA_Aviation_Travel_Management.pdf"
