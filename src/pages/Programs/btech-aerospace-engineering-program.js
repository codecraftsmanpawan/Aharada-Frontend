        ...
        <div className="our-promise-content">
          <div className="our-promise-text">
            ...
            <h2 className="main-heading">
              ...
              <span className="highlight">B.Tech - Aerospace Engineering</span>,
              mastering cutting-edge aerospace technologies and innovations to
          ...
          <div className="job-stats">
            <div className="stat-box">
              <strong>100+</strong>
              <p>Top-tier aerospace companies and startups</p>
            </div>
            <div className="stat-box">
              <strong>1500+</strong>
              <p>
                Global career opportunities in aerospace engineering and
                technology
              </p>
            </div>
            <div className="stat-box">
              <strong>35%</strong>
              <p>Transforming the global aerospace and aviation landscape</p>
            </div>
            <Link
              to="../../assets/img/BTech_Aerospace_Engineering.pdf"
