        ...
        <div className="our-promise-content">
          <div className="our-promise-text">
            ...
            <h2 className="main-heading">
              ...
              <span className="highlight">BBA - FinTech</span>, mastering
              financial technologies and innovation to shape the future of the
              industry.
            </h2>
          ...
          <div className="job-stats">
            <div className="stat-box">
              <strong>100+</strong>
              <p>Top-tier FinTech companies and startups</p>
            </div>
            <div className="stat-box">
              <strong>1500+</strong>
              <p>
                Global career opportunities in FinTech and financial innovation
              </p>
            </div>
            <div className="stat-box">
              <strong>35%</strong>
              <p>Transforming the global financial landscape</p>
            </div>
            <Link
              to="../../assets/img/BBA_FinTech.pdf"
