        ...
        <div className="our-promise-content">
          <div className="our-promise-text">
            ...
            <h2 className="main-heading">
              ...
              <span className="highlight">BFD - Fashion Designing</span>,
              mastering design techniques to shape the future of fashion.
            </h2>
          ...
          <div className="job-stats">
            <div className="stat-box">
              <strong>100+</strong>
              <p>Top-tier fashion design companies</p>
            </div>
            <div className="stat-box">
              <strong>1500+</strong>
              <p>Global career opportunities in fashion design</p>
            </div>
            <div className="stat-box">
              <strong>35%</strong>
              <p>Transforming the fashion industry with creativity</p>
            </div>
            <Link
              to="../../assets/img/BFD_Fashion_Designing.pdf"
