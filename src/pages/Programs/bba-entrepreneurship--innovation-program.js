        ...
        <div className="our-promise-content">
          <div className="our-promise-text">
            ...
            <h2 className="main-heading">
              ...
              , mastering entrepreneurial skills and innovation to shape the
          ...
          <div className="job-stats">
            <div className="stat-box">
              <strong>100+</strong>
              <p>Top-tier entrepreneurship and innovation companies</p>
            </div>
            <div className="stat-box">
              <strong>1500+</strong>
              <p>
            ...
            <div className="stat-box">
              <strong>35%</strong>
              <p>Transforming the entrepreneurial landscape</p>
            </div>
            <Link
              to="../../assets/img/BBA_Entrepreneurship_Innovation.pdf"
